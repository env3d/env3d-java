...
public class ClientHttpRequest {
  ...
  /**
   * Simply prints out all the cookies entry for debugging 
   */
  public static void printCookies() {
      for (Object cookieKey : cookies.keySet()) {
  ...
  public InputStream post() throws IOException {
    ...
    os.close();
    if (cookies.isEmpty()) {
        List<String> cookieStringList = connection.getHeaderFields().get("Set-Cookie");
