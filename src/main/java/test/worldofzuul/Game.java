...
public class Game
{
    ...
    public Game()
    {
        roomLeft = new Room(10, 13.1, 10, "The left room");
        roomRight = new Room(10, 13.1, 10, "The right room");

        roomLeft.setExit("east", roomRight);
        roomLeft.setTextureEast("textures/door.png");
        //roomLeft.setTextureEast(null);
    ...
    private void checkWall()
    {
        if (doty1.getX() > currentRoom.getWidth()-doty1.getScale()) {
            // Going east
            exitTo("east");
            //executeCommand("open http://www.google.com");
